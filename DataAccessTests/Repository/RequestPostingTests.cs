...
namespace DataAccess.Repository.Tests
{
    ...
    public class RequestPostingTests
    {
        ...
        public void RequestPosting_Position_Action_ReturnPostionbyID_Test()
        {
            ...
            //Act
            var position = _action.AppOne.CommonObject<PositionRequesting>("Position", para);
        ...
        [TestMethod()]
        public void RequestPosting_NewRequest_Action_ReturnNewID_Test()
        {
            //Arrange
        ...
        [TestMethod()]
        public void RequestPosting_UpdateRequest_Action_ReturnSuccessfully_Test()
        {
            //Arrange
        ...
        [TestMethod()]
        public void RequestPosting_DeleteRequest_Action_ReturnSuccessfully_Test()
        {
            //Arrange
        ...
        [TestMethod()]
        public void RequestPosting_CallBack_Action_ReturnSuccessfully_Test()
        {
            //Arrange
            ...
            var position = _action.AppOne.CommonObject<PositionRequesting>("Position", paraGet);
        ...
        [TestMethod()]
        public void SpNameTest_ReturnSP_NameandParameters_byActionAndNoAnonymousOBject()
        {
            //Arrange
            string action = "Positions";
        ...
        public void TestCleanup()
        {
            try
            {
                ...
                _action.AppOne.CommonAction("Delete",para);
            }
            catch (Exception)
            {
                throw;
        ...
        private void PerpareForTest(string action)
        {
            try
            {
                ...
                var result = _action.AppOne.CommonAction(action,para); // .AddObj(_para).Replace("Successfully", "");
                _ids = int.Parse(result);
            }
            catch (Exception)
            {
