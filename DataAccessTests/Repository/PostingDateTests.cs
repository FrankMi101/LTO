...
namespace DataAccess.Repository.Tests
{
    ...
    public class PostingDateTests
    {
       ...
       //  private readonly   IAppServices _action = new AppServices( new PostingDate(DBConnection.DBSource));
        ...
        public   void DefaultDateTest_ReturdCurrentSchoolYearPostingDefaultDate()
        {
            ...
            // Act
             var myDate =    _action.AppOne.CommonList<LTODefalutDate>(action,parameter);
        ...
        [TestMethod()]
        public void DefaultDateTest_ReturdCurrentSchoolYearPostingDefaultDateObject()
        {
            // ********* This test will Fail if test happend public hoilday **********
            ...
            // Act
            var myDate = _action.AppOne.CommonObject<LTODefalutDate>(action, parameter);
        ...
        public void DeadlineTest_GivingValidDate_ReturnValid_DeadlineDate()
        {
            ...
            //Act
            string result = _action.AppOne.CommonAction(action, anonyParametere);
