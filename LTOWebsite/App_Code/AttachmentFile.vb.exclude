...
Namespace Attachment
    ...
    Public Class CAttachment
        ...
        Private _AttachFileCount As Integer = 0

        Private _AttachFileName As String = ""
        Private _cFileCollection As CFileCollection = New CFileCollection()
        Public Property GetAttachFiles() As CFileCollection
            Get

                Return _cFileCollection

            End Get

            Set(value As CFileCollection)
        ...
        Public Property GetAttachFileCount() As Integer
        ...
        Public Property GetAttachContent() As String

            Get

                If _EncodeAttach = "" Then

                    EncodeAttach(_EncodeAttach, AttachName, GetAttachFiles)
        ...
        Public Sub New(ByVal attach_name As String, ByVal attach_file As CAttachFile)
            ...
            GetAttachFiles = New CFileCollection

            GetAttachFiles.Add(attach_file)

            _AttachFileCount = GetAttachFiles.Count
        ...
        Public Sub New(ByVal attach_content As String)
            ...
            DecodeAttach(_EncodeAttach, AttachName, GetAttachFiles)
        ...
        Private Function GetBoundary() As String
            ...
            boundary += Now().Ticks.ToString.Substring(10, 8)
    ...
    Public Class CAttachFile
        ...
        Public ReadOnly FileType As String

        Public ReadOnly FileLength As Integer
        ...
        Public Property GetBuf() As Byte()
        ...
        Public Sub DownloadFile(ByVal apage As System.Web.UI.Page)
            ...
            apage.Response.ContentType = FileType

            apage.Response.AppendHeader("Content-Disposition", "attachment;filename=" + FileName)

            apage.Response.AppendHeader("Content-Length", FileLength.ToString)
    ...
    Public Class CFileCollection
        ...
        Public Property GetAttachFiles() As Collection
    ...
    Public Class UpLoadFileData
        ...
        Public Shared Function getAttachmentID(ByVal _user As String, ByVal _action As String, ByVal _IDS As String, ByVal _aTitle As String, ByVal _aFileName As String, ByVal _aCatalog As String, ByVal _comments As String, ByVal _fileLocate As String, ByVal _context As String, ByVal _fileType As String) As String
            Dim _SP As String = "dbo.tcdsb_TPA_AttachmentFiles"
            'Try
            ...
            'Catch ex As Exception
            '    TCDSB.Student.TPA.ShowMsg.Exception(ex, cPage, _SP)
            '    Return ""
            'End Try
            Return ""
        End Function
        Public Shared Function getAttachmentText(ByVal _user As String, ByVal _attaID As String) As String
            Dim _SP As String = "dbo.tcdsb_TPA_AttachmentID_getConText"
            Return ""
            'Try
        ...
        Public Shared Function updateObjectTab(ByVal _user As String, ByVal _IDs As String, ByVal _attaID As String)
            Dim _SP As String = "dbo.tcdsb_TPA_AttachmentID_UpdateMessage"
            Return ""
            'Try
