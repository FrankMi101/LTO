...
Partial Class RequestPosting
    ...
    Private Sub AssiblingPage()
        ...
        AssemblingList.SetLists("", ddlReason, "LeaveReason", parameter)
        AssemblingList.SetLists("", cblQualification, "Qualification_RequestOCT", parameter)
        AssemblingList.SetLists("", rblFTE, "FTEList", parameter)
        AssemblingList.SetLists("", ddlDegree, "TeacherDegree", parameter)
    ...
    Private Sub BindPageData()
        Try
            ...
            AssemblingList.SetValue(ddlDegree, BasePage.getMyValue(position.Degree))
    ...
    Private Sub SaveRequestData()
        ...
        Try
            With myRequestPosting
                ...
                .Degree = Me.ddlDegree.SelectedValue
