<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InterviewSignatureM.aspx.vb" Inherits="InterviewSignatureM" EnableTheming="true" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table>
            <tr>
                <td>
                    <div style="background-image: url(../images/message_body_m.bmp)">
                        ...
                        <table id="SignOffTable" style="width: 100%; border: 1px solid #808080; font-family: Arial, sans-serif; font-size: small">
                            <tr>
            ...
            <tr>
                <td>
                    <div style="font-family: Arial, sans-serif; font-size: small; height: 100%; width: 100%; overflow: auto;">
