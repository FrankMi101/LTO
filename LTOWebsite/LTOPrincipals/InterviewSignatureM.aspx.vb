...
Partial Class InterviewSignatureM
    ...
    Private Sub BindData()
        Try
            ...
            With parameter
                ...
                .CPNum = cpnum
            End With
            Dim SP As String = CommonExcute.SPNameAndParameters("", cPage, "Signatures")
    ...
    Private Sub CreateAuthTicket()
        ...
        End With
        Dim SP As String = CommonExcute.SPNameAndParameters(DataAccessFile, cPage, "SignatureName")
