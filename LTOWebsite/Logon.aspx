                                ...
                                <table id="Table1" style="width: 400px; height: 350px" cellspacing="1" cellpadding="1"
                                    ...
                                    <tr>
                                        ...
                                        <td valign="middle" align="left" style="width: 50%">
                                            <table id="Table2" cellspacing="1" cellpadding="1" align="left" border="0" style="width: 199px; height: 165px; font-size: x-small">
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtDomain" runat="server" Width="124px" CssClass="textField">CEC</asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td align="left" colspan="2" style="height: 26px">
                                                        <asp:CheckBox ID="chkPersist" runat="server" Text="Persist Cookie" Visible="False"></asp:CheckBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td></td>
