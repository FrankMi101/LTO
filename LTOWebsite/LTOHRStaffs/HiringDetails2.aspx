<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HiringDetails2.aspx.vb" Inherits="HiringDetails2" EnableTheming="true" %>
        ...
        <div style="background-image: url(../images/message_body_m.bmp)">
            ...
            <table style="width: 100%">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextName" runat="server" BackColor="Transparent"  Width="110px" ></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        <asp:Label ID="lblTeacherPersonID" runat="server"   Width="100px" Text="teacher person id"></asp:Label>
                    </td>
                    <td class="noWrap">OT PRNR.</td>
                    <td>
                        <asp:Label ID="lblTeacherOTPrnr" runat="server"  Width="100px" Text="OT Prnr"></asp:Label>
                    </td>
                    <td class="noWrap">OCT No.</td>
                    <td>
                        <asp:Label ID="lblTeacherOCT" runat="server" Text="OCT Number"  Width="100px"></asp:Label>
                    </td>
                ...
                <tr>
                    ...
                    <td colspan="7" style="width: 85%">
                        <asp:TextBox ID="TextPositionTitle" runat="server"   Width="75%" BackColor="Transparent"></asp:TextBox>
                        FTE
                        <asp:Label ID="lblPositionFTE" runat="server"  Width="30px" BackColor="Transparent"></asp:Label>
                        <asp:Label ID="lblPostingCycle" runat="server"   Width="70px" BackColor="Transparent"></asp:Label>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <asp:Label ID="lblTeacherBeReplaced" runat="server" Text="teacher name"></asp:Label> Person ID  <asp:Label ID="lblTeacherBeReplacedPersonID" runat="server" Text="person id"></asp:Label>
                    </td>
                    <td class="noWrap">Reason for leave </td>
                    <td colspan="2">
                           <asp:Label ID="lblReasonReplacement" TabIndex="14" runat="server"   Width="99%"></asp:Label>
                    </td>
