    ...
    Private Sub GetUserSecurityProfile()
        Try
            ...
            If Me.hfLoginRole.Value = "Admin" Or Me.hfLoginRole.Value = "HRStaff" Or Me.hfLoginRole.Value = "HRStaff4" Then
                _lblStr4 = "   &nbsp;&nbsp;   &nbsp;&nbsp;  " + "  Login as: " + "<a title= 'click on the role to change the Login Role ' href='Default_role.aspx' target='mainTop'>" + WorkingProfile.UserRole + "</a>"
            Else
                _lblStr4 = " &nbsp;&nbsp; &nbsp;&nbsp; Login as: " + WorkingProfile.UserRole
            End If
            If Me.hfLoginRole.Value = "Admin" Or Me.hfLoginRole.Value = "HRStaff" Or Me.hfLoginRole.Value = "HRStaff4" Then
